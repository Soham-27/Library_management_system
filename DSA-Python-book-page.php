...
<head>
    ...
    <link rel="stylesheet" href="DSA-Python-book-page.css">
    <style>
    ...
    <main>
        <section class="container">
            ...
            <div class="book-description">
                <h1>Data Structures & Algorithm with Python</h1>
                <p>Undergraduate Topics in Computer Science</p> <br>
                <span class="author">
                    <p style="color: #5d5c5c;">Authors - </p>
                    <p id="author-1">Kent D. Lee, </p>
                    <p id="author-2">Steve Habbard</p>
                </span>
