...
<head>
    ...
    <link rel="stylesheet" href="blockchain-book-page.css">
    <style>
    ...
    <main>
        <section class="container">
            ...
            <div class="book-description">
                <h1>The Blockchain Developer</h1> <br>
                <span class="author">
                    <p style="color: #5d5c5c;">Authors - </p>
                    <p id="author-1">Elad Elrom</p>
                </span>
                <span class="publication">
                    <p style="color: #5d5c5c;">Publication : Springer <br>
                ...
                <p>Description - <br><br>
                    ...
                    Don’t be left out of the next technology revolution – become a Blockchain developer using
                </p>
            </div>
            <div class="book-info">
